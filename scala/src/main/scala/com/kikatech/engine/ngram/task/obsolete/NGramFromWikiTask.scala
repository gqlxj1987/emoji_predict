...
import com.kikatech.engine.ngram.analyzer.obsolete.NGramFromWikiAnalyzer
...
/**
  ...
  */
object NGramFromWikiTask extends AnalyzeTask {
  ...
  def main(args: Array[String]) {
    ...
    val analyzer = new NGramFromWikiAnalyzer
