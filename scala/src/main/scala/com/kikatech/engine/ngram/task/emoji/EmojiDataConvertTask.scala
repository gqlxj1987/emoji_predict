...
import com.kikatech.engine.ngram.analyzer.emoji.EmojiDataConvertAnalyzer
...
/**
  ...
  */
object EmojiDataConvertTask extends AnalyzeTask {
  ...
  def main(args: Array[String]) {
    ...
    val analyzer = new EmojiDataConvertAnalyzer
